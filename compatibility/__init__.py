...
_IMPORT_PLAN = {
    ...
    # ---- Memory + sync ----
    "memory_map":           ("CreateFileMappingA", "OpenFileMappingA",
                             "MapViewOfFile", "UnmapViewOfFile",
                             "FlushViewOfFile", "CloseMappingHandle",
                             "FileMapping", "MappedView",
                             "PAGE_READWRITE", "PAGE_EXECUTE_READWRITE",
                             "FILE_MAP_ALL_ACCESS", "FILE_MAP_READ",
                             "EXPORTS"),
    "sync":                 ("CriticalSection", "SrwLock", "ConditionVariable",
                             "InitOnce",
                             ...
                             "create_critical_section", "create_srw_lock",
                             "create_condition_variable", "create_init_once",
                             "EXPORTS"),
    ...
    # ---- Installer / Win10 application surface ----
    "version_info":         ("VersionInfo", "VsFixedFileInfo",
                             "VersionStringTable",
                             "parse_version_info",
                             "VerQueryValue",
                             "GetFileVersionInfoSize"),
    "delay_imports":        ("DelayImportDirectory", "DelayImportEntry",
                             "DelayImportSymbol", "parse_delay_imports"),
    "signed_pe":            ("SignedPeInfo", "WinCertificate",
                             "CertificateSubject", "parse_certificates",
                             "WinVerifyTrust",
                             "WINTRUST_ACTION_GENERIC_VERIFY_V2",
                             "TRUST_E_NOSIGNATURE", "TRUST_E_EXPLICIT_DENY"),
    "winsock":              ("WSAStartup", "WSACleanup", "socket", "bind",
                             "listen", "accept", "connect", "send", "recv",
                             "gethostname", "gethostbyname",
                             "inet_addr", "inet_ntoa",
                             "htons", "htonl", "ntohs", "ntohl",
                             "SockAddrIn", "WSAData", "EXPORTS"),
    "timezone":             ("SystemTime", "FileTime", "TimeZoneInformation",
                             "GetSystemTime", "GetLocalTime", "SetSystemTime",
                             "GetTickCount", "SystemTimeToFileTime",
