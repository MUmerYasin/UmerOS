...
ESSENTIAL_LIBRARIES: List[SharedLibrary] = [
    ...
    SharedLibrary(
        ...
        version="2.31",
        description="The dynamic linker/loader for x86 (32-bit)",
        size_bytes=186_896,
    ...
    SharedLibrary(
        ...
        version="2.31",
        description="The dynamic linker/loader for x86-64 (64-bit)",
        size_bytes=202_952,
        symlink_target="ld-2.31.so",
    ),
    SharedLibrary(
        ...
        path="/lib/ld-2.31.so",
        version="2.31",
        description="The dynamic linker/loader (main file)",
        size_bytes=202_952,
    ),
