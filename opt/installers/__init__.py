# UmerOS /opt/installers — Pre-built package installers
# ======================================================
...
log = logging.getLogger("UmerOS.Opt.Installers")
...
for _mod, _names in (
    ("sample_app", ("install_sample_app",)),
    ("web_server", ("install_web_server",)),
...
def _selftest() -> bool:
    ...
    if missing:
        print(
            f"opt.installers selftest FAIL: missing {missing}",
            file=sys.stderr,
        )
        return False
    return True
