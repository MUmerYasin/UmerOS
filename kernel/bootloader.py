...
# ==============================================================================
# AUTO-PATH RESOLUTION FIX (Prevents "No module named" errors)
# ==============================================================================
# 1. Get the directory where this bootloader.py file is located
current_file_dir = os.path.dirname(os.path.abspath(__file__))

# 2. Add the 'kernel' directory to Python's search path
if current_file_dir not in sys.path:
    sys.path.insert(0, current_file_dir)

# 3. Add the parent 'UmerOS' root directory to Python's search path
# (This allows imports like 'from security.sandbox import ...' to work)
...
async def main():
    ...
    try:
        # Now Python will successfully find umer_kernel.py
        ...
        print(f"Details: {e}")
        print("\n💡 TROUBLESHOOTING:")
        print("1. Ensure 'umer_kernel.py' is in the exact same folder as 'bootloader.py'.")
        print("2. Ensure you have installed dependencies: pip install numpy psutil")
        sys.exit(1)
