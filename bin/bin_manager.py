"""
    "bash": bin.bash:BashCommand,
    "busybox": bin.bash:BusyboxCommand,
    "cowsay": bin.usr_games:CowsayCommand,
    "cpu-config": bin.usr_include:CpuConfigCommand,
    "dash": bin.bash:DashCommand,
    "doc": bin.usr_doc:DocCommand,
    "fish": bin.bash:FishCommand,
    "fortune": bin.usr_games:FortuneCommand,
    "gnu-stubs": bin.usr_include:GnuStubsCommand,
    "include-dir": bin.usr_include:IncludeDirCommand,
    "infodir": bin.usr_doc:InfoDirCommand,
    "ksh": bin.bash:KshCommand,
    "ld-linux": bin.usr_lib:LdLinuxCommand,
    "ld-preload": bin.usr_lib:LdPreloadCommand,
    "ldconfig": bin.usr_lib:LdConfigCommand,
    "lib-dir": bin.usr_lib:LibDirCommand,
    "lib-modules": bin.usr_lib:UsrLibModulesCommand,
    "man-cmd": bin.usr_man:ManCmdCommand,
    "man-dir": bin.usr_man:ManDirCommand,
    "manpath": bin.usr_man:ManPathCommand,
    "mksh": bin.bash:MkshCommand,
    "ncurses-demo": bin.usr_games:NcursesDemoCommand,
    "pkg-config": bin.usr_include:PkgConfigCommand,
    "pkg-config-lib": bin.usr_include:PkgConfigLibCommand,
    "pkg-doc": bin.usr_doc:PkgDocCommand,
    "pkgconfig": bin.usr_lib:PkgConfigLibCommand,
    "sl": bin.usr_games:SlCommand,
    "src-dir": bin.usr_src:SrcDirCommand,
    "src-kernel-headers": bin.usr_src:SrcKernelHeadersCommand,
    "src-linux": bin.usr_src:SrcLinuxCommand,
    "src-rpm-build": bin.usr_src:SrcRPMBuildCommand,
    "tcsh": bin.bash:TcshCommand,
    "usr-apropos": bin.usr_man:UsrAproposCommand,
    "usr-etc": bin.usr_etc:UsrEtcCommand,
    "usr-etc-default": bin.usr_etc:UsrEtcDefaultCommand,
    "usr-etc-profile": bin.usr_etc:UsrEtcProfileCommand,
    "usr-info": bin.usr_doc:UsrInfoCommand,
    "usr-tmp": bin.usr_tmp:UsrTmpCommand,
    "usr-tmp-link": bin.usr_tmp:UsrTmpLinkCommand,
    "usr-whatis": bin.usr_man:UsrWhatisCommand,
    "x11r6-bin": bin.usr_x11r6:X11R6BinCommand,
    "x11r6-doc": bin.usr_x11r6:X11R6DocCommand,
    "x11r6-fonts": bin.usr_x11r6:X11R6FontsCommand,
    "x11r6-include": bin.usr_x11r6:X11R6IncludeCommand,
    "x11r6-lib": bin.usr_x11r6:X11R6LibCommand,
    "x11r6-lib-modules": bin.usr_x11r6:X11R6LibModulesCommand,
    "xclock": bin.usr_games:XclockCommand,
    "xeyes": bin.usr_games:XeyesCommand,
    "xorg": bin.usr_x11r6:XorgCommand,
    "xterm": bin.usr_games:XtermCommand,
    "zsh": bin.bash:ZshCommand,
