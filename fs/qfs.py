...
class QFS:
    ...
    # ── Legacy API shims (backwards-compatibility) ─────────────────────────

    def write(self, path: str, data: bytes) -> str:
        """Alias for write_file() — backwards-compatible with old QuantumFileSystem API."""
        return self.write_file(path, data)

    def read(self, path: str) -> bytes:
        """Alias for read_file() — backwards-compatible with old QuantumFileSystem API."""
        return self.read_file(path)

    def delete(self, path: str) -> bool:
        """Alias for delete_file() — backwards-compatible with old QuantumFileSystem API."""
        return self.delete_file(path)


# Backwards-compatibility alias: code importing QuantumFileSystem still works
QuantumFileSystem = QFS
