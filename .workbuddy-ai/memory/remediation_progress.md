...
Next: **H38** — `bin/usr_cmds.py:3045` + `bin/usr_commands.py:1938` `ChageCommand` defined in two different modules (duplicate implementations that can drift). Say **'continues'** for H38.
