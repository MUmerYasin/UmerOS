...
## NEXT (where to pick up) — core/ sweep (session 71)
...
Next: **H57** — `core/` (H55,H56 now 🟢; H57 is the last open YELLOW in `core/` - `core/command.py` tier label + GPL header). Say **'continues'** for H57.
