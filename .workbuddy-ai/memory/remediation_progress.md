...
## NEXT (where to pick up) — bin/ sweep (session 56)
...
Next: **H40** — `bin/` (0 of 44 modules) No `bin/` module carries a `[TODAY]/[EXPERIMENTAL]/[FUTURE]` tier label. Say **'continues'** for H40.
