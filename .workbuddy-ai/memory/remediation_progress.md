...
## NEXT (where to pick up) — build/ sweep (session 60)
...
Next: **H43** — `build/UmerOS-GUI.spec:5` **Hardcoded absolute Windows path** `F://Pension Person Details\UmerOS\ui\umeros_gui.py` — non-portable, machine-specific (H43). Note: H41 resolved (entry repointed to `launch_gui.py`); H42 already 🟢. Say **'continues'** for H43.
