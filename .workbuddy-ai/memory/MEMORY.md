...
- DONE: var/ (H303,H305,H306,H307 — session 1); path-traversal cluster (H185,H186,H194,H195,H265,H266,H282 — session 2) + unblocked harness; **fail-open + dummy-crypto cluster** (H129,H146,H111,H152,H154,H196,H197 — session 3) + srv/* relative-import repair (H271 smell) + `cryptography`/`numpy` in venv; 59 remediation tests green.
- NEXT cluster: **cap-gate (wire `CapabilityManager`)** — H227,H233,H267,H273,H281,H283,H296,H304 (then full YELLOW/BLUE sweep; outstanding H7 licence sweep in opt/config.py, opt/var.py, opt/package.py, srv/backup.py, packages/umer_pkg.py, tmp/tmpfs.py headers — `Licence: Apache 2.0`→`License: GPL-3.0`).
...
- root/ 🟡 H226/H227/H228; 💭 H229/H230/H231
- sbin/ 🟡 H232; 💭 H233/H234/H235
- scripts/ 🟡 H236/H237; 💭 H238/H239
- sdk/ 🟡 H240/H241; 💭 H242/H243
- security/ 🔴 H244/H245/H246; 🟡 H247–H254; 💭 H255–H258
- sources/ 🟡 H259/H260/H261/H262; 💭 H263/H264
- srv/ 🔴 H265/H266/H267/H268 (H265/H266 FIXED; sibling imports now relative — H271); 🟡 H269/H270/H272/H273; 💭 H274–H277
- tmp/ 🟡 H278/H279/H280/H281/H282/H283 (H282 FIXED); 💭 H284–H287
- tools/ 🟡 H288–H292; 💭 H293–H295
- usr/ 🟡 H296/H297/H298/H299/H300; 💭 H301/H302
- var/ 🔴 H303 (FIXED); 🟡 H304/H305/H306 (FIXED); 💭 H307 (FIXED)
